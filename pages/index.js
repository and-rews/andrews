...
const Home = () => {
  return (
    <div className="bg-primary/60 h-full">
      <div className="w-full h-[90vh] bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
      ...
      <div>Particles</div>
      <div className="w-full h-full max-w-[737px] max-h-[678px] absolute -bottom-32 lg:bottom-0 lg:right-[2%]">
        <Avatar />
      </div>
    </div>
  );
